...
const appCss = "/assets/styles-BtooXIYI.css";
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Pixel Perfect Pixels is a frontend application that faithfully recreates a website design across desktop and mobile devices." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Pixel Perfect Pixels is a frontend application that faithfully recreates a website design across desktop and mobile devices." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Pixel Perfect Pixels is a frontend application that faithfully recreates a website design across desktop and mobile devices." }
    ],
    links: [
      {
        rel: "stylesheet",
...
const $$splitComponentImporter = () => import("./index-Bpq_TDXx.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Jornal Marabá: notícias, cidadania, comércio, política, saúde e eventos da cidade de Marabá - Pará."
    }, {
      property: "og:title",
      content: "Jornal Marabá"
    }, {
